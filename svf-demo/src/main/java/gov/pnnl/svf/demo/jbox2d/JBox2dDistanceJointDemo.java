...
import gov.pnnl.svf.demo.JBox2dDistanceJointLoader;
 ...
 */
public class JBox2dDistanceJointDemo extends AbstractAwtDemo {
    ...
    public AbstractScene<GLCanvas> createScene(final JFrame window, final SceneBuilder builder) {
        ...
        final AwtScene scene = new AwtScene(component, builder) {
            @Override
            public void load() {
                final JBox2dDistanceJointLoader loader = new JBox2dDistanceJointLoader();
                loader.load(this);
            }
