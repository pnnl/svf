...
import gov.pnnl.svf.demo.JBox2dPhysicsLoader;
 ...
 */
public class JBox2dPhysicsDemo extends AbstractAwtDemo {
    ...
    public AbstractScene<GLCanvas> createScene(final JFrame window, final SceneBuilder builder) {
        ...
        final AwtScene scene = new AwtScene(component, builder) {
            @Override
            public void load() {
                final JBox2dPhysicsLoader loader = new JBox2dPhysicsLoader();
                loader.load(this);
            }
