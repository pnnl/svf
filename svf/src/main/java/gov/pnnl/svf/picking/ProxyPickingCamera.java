 ...
 */
public class ProxyPickingCamera extends AbstractPickingCamera {
     ...
     */
    public ProxyPickingCamera(final Scene scene, final Camera camera) {
        super(scene, camera);
    }
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public ProxyPickingCamera(final Scene scene, final String id, final Camera camera) {
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public ProxyPickingCamera(final Scene scene, final String type, final String id, final Camera camera) {
