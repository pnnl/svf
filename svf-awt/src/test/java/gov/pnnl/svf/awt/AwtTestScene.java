...
public class AwtTestScene implements SceneExt {
    ...
    public AwtTestScene(final int width, final int height) {
        this.width = width;
        this.height = height;
    }
    ...
    public void setUp() throws Exception {
        ...
        final GLCanvas component = new GLCanvas(sceneBuilder.getGLCapabilities());
        frame.add(component, BorderLayout.CENTER);
        scene = AwtScene.newInstance(component, sceneBuilder);
        frame.validate();
