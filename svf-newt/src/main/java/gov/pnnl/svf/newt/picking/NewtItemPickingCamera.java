 ...
 */
public class NewtItemPickingCamera extends AbstractItemPickingCamera implements MouseListener, KeyListener {
     ...
     */
    public NewtItemPickingCamera(final Scene scene, final Camera camera) {
        super(scene, camera);
    }
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public NewtItemPickingCamera(final Scene scene, final String id, final Camera camera) {
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public NewtItemPickingCamera(final Scene scene, final String type, final String id, final Camera camera) {
