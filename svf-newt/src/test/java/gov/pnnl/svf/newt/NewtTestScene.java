...
public class NewtTestScene implements SceneExt {
    ...
    private GLWindow frame;

    public NewtTestScene() {
        this(800, 600);
    }

    public NewtTestScene(final int width, final int height) {
        this.width = width;
        this.height = height;
    }
    ...
    public void setUp() throws Exception {
        ...
        frame = GLWindow.create(sceneBuilder.getGLCapabilities());
        ...
        scene = NewtScene.newInstance(frame, sceneBuilder);
