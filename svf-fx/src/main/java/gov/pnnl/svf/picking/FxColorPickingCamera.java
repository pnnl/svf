...
public class FxColorPickingCamera extends AbstractColorPickingCamera implements FxEventHandler<InputEvent> {
     ...
     */
    public FxColorPickingCamera(final Scene scene, final Camera camera) {
        super(scene, camera);
    }
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public FxColorPickingCamera(final Scene scene, final String id, final Camera camera) {
     ...
     * @param camera The view into the scene that will be used for picking.
     */
    public FxColorPickingCamera(final Scene scene, final String type, final String id, final Camera camera) {
