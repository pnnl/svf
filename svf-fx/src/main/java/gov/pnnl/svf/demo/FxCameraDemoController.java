 ...
 */
public class FxCameraDemoController implements Initializable {

    private static final Logger logger = Logger.getLogger(FxCameraDemoController.class.getName());
    ...
    @FXML
    private FxCameraDemoScene scene;
