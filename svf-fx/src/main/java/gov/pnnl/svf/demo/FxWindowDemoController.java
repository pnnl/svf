 ...
 */
public class FxWindowDemoController implements Initializable {

    private static final Logger logger = Logger.getLogger(FxWindowDemoController.class.getName());
    /**
     * Demo window height.
     */
    ...
    @FXML
    private FxWindowDemoScene scene;
