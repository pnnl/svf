...
public class FxPickingDemoController implements Initializable {
    ...
    private static final Logger logger = Logger.getLogger(FxPickingDemoController.class.getName());
    /**
     * Demo window height.
     */
    ...
    @FXML
    private FxPickingDemoScene scene;
    ...
    public void initialize(final URL url, final ResourceBundle rb) {
        ...
        builder.setTargetFps(60)
                ...
                .setNumberOfUserInterfaceDrawingPasses(2)
                .setDebug(true)
                .setDisplayFps(true)
                .setVerbose(false);
